...
<div class="language-switcher" aria-label="<?php esc_attr_e('Language switcher', 'spek-theme'); ?>">
    <a href="<?php echo esc_url($el_url); ?>" class="<?php echo $current === 'el' ? 'is-active' : ''; ?>" lang="el" hreflang="el" aria-label="Ελληνικά"<?php if ($current === 'el') : ?> aria-current="true"<?php endif; ?>>
        <img src="https://flagcdn.com/gr.svg" width="24" height="16" alt="Ελληνικά">
    </a>
    <?php if ($en_url !== '') : ?>
